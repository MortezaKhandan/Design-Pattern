...
/*
This sample does not have director
https://github.com/mr-mousavi/design-pattern
*/
...
int main()
{
    ...
    // there is no director to create the object 
    ...
    // it should be somethine like below if we have drector 
    // Email mail = Make gmail 
    // Email mail_1 = Make officialmail 
    cout << mail << endl;
}
